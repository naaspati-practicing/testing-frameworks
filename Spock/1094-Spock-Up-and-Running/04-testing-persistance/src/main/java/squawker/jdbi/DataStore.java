...
public interface DataStore {
	...
	@SqlQuery("SELECT *, m.id as mid, u.id as uid FROM MESSAGES m LEFT JOIN USERS u ON m.posted_by = u.id  WHERE m.posted_by = (SELECT id FROM USERS WHERE username=:u.username)")
	List<Message> postsBy(@BindBean("u") User user) ;

...
import sam.learn.spock.nuclear.NuclearReactorMonitor;
import sam.learn.spock.nuclear.NuclearReactorStatus;
...
public class NuclearReactorTest {
	...
	public NuclearReactorTest(int pressure, int triggeredFireSensors, List<Float> radiationDataReadings,
			boolean expectedAlarmStatus, boolean expectedShutdownCommand, int expectedMinutesToEvacuate) {
	...
	public static Collection<Object[]> data() {
		return asList(new Object[][] { 
			...
			{ 150, 1, new ArrayList<Float>(), true, false, -1 }, { 150, 3, new ArrayList<Float>(), true, true, -1 },
			{ 150, 0, asList(110.4f, 0.3f, 0.0f), true, true, 1 },
			{ 150, 0, asList(45.3f, 10.3f, 47.7f), false, false, -1 },
			{ 155, 0, asList(0.0f, 0.0f, 0.0f), true, false, -1 },
			{ 170, 0, asList(0.0f, 0.0f, 0.0f), true, true, 3 },
			{ 180, 0, asList(110.4f, 0.3f, 0.0f), true, true, 1 },
			{ 500, 0, asList(110.4f, 300f, 0.0f), true, true, 1 },
			{ 30, 0, asList(110.4f, 1000f, 0.0f), true, true, 1 },
			{ 155, 4, asList(0.0f, 0.0f, 0.0f), true, true, -1 },
			{ 170, 1, asList(45.3f, 10.3f, 47.7f), true, true, 3 }, 
			});
	}
}
